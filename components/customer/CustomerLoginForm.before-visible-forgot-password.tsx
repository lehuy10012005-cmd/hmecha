...
export default function CustomerLoginForm() {
  ...
  return <>
    ...
    <form onSubmit={submit} className="authForm">
      ...
      <label>Mật khẩu<input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Nhập mật khẩu" required /></label><div style={{ textAlign: "right", marginTop: -8 }}><Link href="/quen-mat-khau" style={{ color: "#00e5ff", fontWeight: 850, fontSize: 14, textDecoration: "none" }}>Quên mật khẩu?</Link></div>
