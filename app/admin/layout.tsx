...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  <Link href="/admin">Dashboard</Link>
          <Link href="/admin/dashboard-2">Dashboard 2</Link>
  <Link href="/admin/products">Sản phẩm</Link> <Link href="/admin/ton-kho">Tồn kho</Link>
  <Link href="/admin/products/new">Thêm sản phẩm</Link>
  <Link href="/admin/orders">Đơn hàng</Link> <Link href="/admin/bao-cao">Báo cáo</Link> <Link href="/admin/ma-giam-gia">Mã giảm giá</Link> <Link href="/admin/chatbot">Chatbot</Link>
